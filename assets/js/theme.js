...
ga('create', googleConfig.analytics_tracking_id, 'auto');
ga('send', 'pageview');
WebFontConfig = {
  google: { families: [ googleConfig.fonts_family ] }
};
(function() {
...
(function ($) {
    ...
    $(document).ready(function(){
		...
		$(".at_search_input").ghostHunter({results: ".at_search_results", onKeyUp: true, info_template: "<span class='at_search_clear_toggle'>&#215;</span> <span class='at_search_results_amount'>Nombre de billet trouvé : {{amount}}</span><span class='clearfix'></span>", result_template : "<span><a href='{{link}}'><span class='at_search_results_title'>{{title}}</span></a></span>"});
